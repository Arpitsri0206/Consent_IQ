...
export const INITIAL_CONSENTS: ConsentItem[] = [
  ...
  {
    id: 'TA-CNS-2026-000128',
    tenantId: 'org_apex',
    brandName: 'Apex Financial Services',
    brandLogo: '🏦',
    brandIndustry: 'BFSI & Wealth Management',
    purposeId: 'purp_apex_kyc',
    purposeName: 'Account Management & Digital KYC',
    purposeDescription: 'Aadhaar offline XML and video KYC consent collected via WhatsApp Interactive Chat.',
    businessObjective: 'Statutory compliance with RBI KYC master directions and DPDP mandate.',
    dataCategories: ['Identity', 'Contact', 'Financial'],
    status: 'GRANTED',
    grantedAt: '2026-09-05 04:15 PM IST',
    expiresAt: '2031-09-05 04:15 PM IST',
    requestedAt: '2026-09-05 04:12 PM IST',
    noticeVersion: 'v2.1',
    noticeId: 'notc_apex_v21',
    collectionChannel: 'WhatsApp',
    retentionPeriod: '5 years after account closure',
    thirdParties: ['UIDAI Offline KYC API', 'Gupshup WhatsApp BSP'],
    userRef: 'USR-8F3A2',
    userName: 'Arpit Sharma',
    userEmail: 'arpit.demo@example.com',
    evidenceHash: '7a12bc90e44f8812ad3490ef11bc7709e3412a88bf019c4391e00f912a3488dc',
    previousHash: '5e7a91bf33c82901ad4487ef99012a88bf019c4391e00f912a3488dc9901ef23'
  },
  {
    id: 'TA-CNS-2026-000129',
    tenantId: 'org_travelkart',
    brandName: 'TravelKart India',
    brandLogo: '✈️',
    brandIndustry: 'Travel & Hospitality',
    purposeId: 'purp_travelkart_deals',
    purposeName: 'Flight Schedule & Baggage SMS Notifications',
    purposeDescription: 'Real-time SMS dispatch for terminal updates, gate changes, and delay alerts.',
    businessObjective: 'Critical travel itinerary communication.',
    dataCategories: ['Contact', 'Location'],
    status: 'GRANTED',
    grantedAt: '2026-09-06 11:30 AM IST',
    expiresAt: '2027-09-06 11:30 AM IST',
    requestedAt: '2026-09-06 11:28 AM IST',
    noticeVersion: 'v1.4',
    noticeId: 'notc_travelkart_v14',
    collectionChannel: 'SMS',
    retentionPeriod: '12 months',
    thirdParties: ['Telecom DLT Gateway (VK-TRVLKT)', 'ValueFirst SMS'],
    userRef: 'USR-8F3A2',
    userName: 'Arpit Sharma',
    userEmail: 'arpit.demo@example.com',
    evidenceHash: '1f90ac88d9012e44bc5567aa129034fe88ab12e345b128fa9c445ee1098bca43',
    previousHash: '7a12bc90e44f8812ad3490ef11bc7709e3412a88bf019c4391e00f912a3488dc'
  },
  {
    id: 'TA-CNS-2026-000130',
    tenantId: 'org_apex',
    brandName: 'Apex Financial Services',
    brandLogo: '🏦',
    brandIndustry: 'BFSI & Wealth Management',
    purposeId: 'purp_apex_marketing',
    purposeName: 'Priority Wealth Advisory Inbound Call',
    purposeDescription: 'Voice recorded tele-consent for personal relationship manager portfolio allocation.',
    businessObjective: 'Deliver personalized wealth management services.',
    dataCategories: ['Identity', 'Financial'],
    status: 'GRANTED',
    grantedAt: '2026-09-07 09:10 AM IST',
    expiresAt: '2028-09-07 09:10 AM IST',
    requestedAt: '2026-09-07 09:05 AM IST',
    noticeVersion: 'v2.1',
    noticeId: 'notc_apex_v21',
    collectionChannel: 'IVR',
    retentionPeriod: '24 months',
    thirdParties: ['Exotel Voice Trunk', 'Apex Telephony Archiver'],
    userRef: 'USR-8F3A2',
    userName: 'Arpit Sharma',
    userEmail: 'arpit.demo@example.com',
    evidenceHash: 'bb4459012ac88d0981e42ba9c8789ef0123984aa910cbe77298d01ef8324a9b0',
    previousHash: '1f90ac88d9012e44bc5567aa129034fe88ab12e345b128fa9c445ee1098bca43'
  }
];
